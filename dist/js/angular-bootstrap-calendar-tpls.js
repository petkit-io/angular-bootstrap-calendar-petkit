...
/***/ function(module, exports, __webpack_require__) {
	...
	var getDayView = function (_a) {
	    ...
	    var dayViewEvents = getEventsInPeriod({
	        ...
	        if(event.type && event.type==2) {
	        	var overlappingPreviousEvents = previousDayEvents2.filter(function (previousEvent) {
	            var previousEventTop = previousEvent.top;
	            var previousEventBottom = previousEvent.top + 30;
	        	...
	        	var right = 0;
		        while (overlappingPreviousEvents.some(function (previousEvent) { return previousEvent.right === right; })) {
		            right += 50;
		        }
		        var dayEvent = {
		            event: event,
	        ...
	        if (height > 0) {
	        	if(event.type && event.type==2){
	            	previousDayEvents2.push(dayEvent);
	        	} else {
